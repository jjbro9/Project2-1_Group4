...
def main():
    ...
    parser.add_argument("--buffer-size", type=int, default=10240, help="Buffer size")
    parser.add_argument("--learning-rate", type=float, default=3.0e-4, help="Learning rate")
    parser.add_argument("--beta", type=float, default=5.0e-4, help="Beta (entropy regularization)")
    parser.add_argument("--epsilon", type=float, default=0.2, help="Epsilon (PPO clip)")
    parser.add_argument("--lambd", type=float, default=0.95, help="Lambda (GAE)")
    parser.add_argument("--num-epoch", type=int, default=3, help="Number of epochs")
    parser.add_argument("--learning-rate-schedule", choices=["linear", "constant"], default="linear", help="LR schedule")

    # Network settings
    parser.add_argument("--normalize", type=bool, default=False, help="Normalize observations")
    parser.add_argument("--hidden-units", type=int, default=128, help="Hidden units per layer")
    parser.add_argument("--num-layers", type=int, default=2, help="Number of hidden layers")

    # Reward signals
    parser.add_argument("--gamma", type=float, default=0.99, help="Discount factor")
    parser.add_argument("--reward-strength", type=float, default=1.0, help="Extrinsic reward strength")

    # Training settings
    parser.add_argument("--max-steps", type=int, default=50000, help="Maximum training steps")
    parser.add_argument("--time-horizon", type=int, default=64, help="Time horizon")
    parser.add_argument("--summary-freq", type=int, default=10000, help="Summary frequency")
